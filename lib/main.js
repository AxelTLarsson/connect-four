...
$(document).ready(function() {
    ...
    restoreOldInstance();
    // Fill in (restored) highscore list if saved
    updateHighscore();
    ...
    */
        ...
        $('#game').on('click', '#gameBoard tr td', function(e) {
            ...
            if (row === false) {
                ...
                if (game.isWon(row, col)) {
                    ...
                    audit.log('Saving highscore object');
    ...
    function restoreOldInstance() {
        ...
        if (typeof oldInstance !== 'undefined' && oldInstance) {
            ...
            audit.log('Previous game instance loaded');

        } else {
            audit.log('No previous game instance found, starting new game');
        }
